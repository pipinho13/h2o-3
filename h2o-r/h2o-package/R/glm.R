...
#'        one of: "gaussian", "binomial", "quasibinomial", "multinomial", "poisson", "gamma", "tweedie", "ordinal".
...
h2o.glm <- function(x, y, training_frame,
                    ...
                    offset_column = NULL,
                    weights_column = NULL,
                    family = c("gaussian", "binomial", "quasibinomial", "multinomial", "poisson", "gamma", "tweedie", "ordinal"),
